...
// Einföldum skilin til að auka lesanleika skilgreininga
private static int step(String lex, int token) {
	lexeme = lex;
	return token;
}
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 14: break;
          case 3: 
            { return step(yytext(), LITERAL);
            }
          case 15: break;
          case 4: 
            { return step(yytext(), OPNAME);
            }
          case 16: break;
          case 5: 
            { return step(yytext(), NAME);
            }
          case 17: break;
          case 6: 
            { return step(yytext(), yycharat(0));
            }
          case 18: break;
          case 7: 
